...
<section class="content">
    ...
    <div class="box box-solid">
      ...
      <div class="box-header with-border">
        <h2 class="box-title">Add SIDA Law</h2>
        <div class="pull-right">
            <code>Fields with asterisks(*) are required</code>
        </div> 
      </div>
      
      <form method="POST" autocomplete="off" action="{{ route('dashboard.sida_law.store') }}" enctype="multipart/form-data">
...
@section('scripts')
  ...
  <script type="text/javascript">
    ...
    @if(Session::has('SIDA_LAW_CREATE_SUCCESS'))
      {!! __js::toast(Session::get('SIDA_LAW_CREATE_SUCCESS')) !!}
    @endif
