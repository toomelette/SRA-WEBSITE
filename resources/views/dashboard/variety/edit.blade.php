...
<section class="content">
    ...
    <div class="box box-solid">
      ...
      <div class="box-header with-border">
        <h2 class="box-title">Edit Variety</h2>
      ...
      <form method="POST" autocomplete="off" action="{{ route('dashboard.variety.update', $variety->slug) }}" enctype="multipart/form-data">
        ...
        <div class="box-body">
          <div class="col-md-12">
            ...
            {!! __form::textbox(
              '7', 'name', 'text', 'Name *', 'Name', old('name') ? old('name') : $variety->name, $errors->has('name'), $errors->first('name'), ''
            ) !!}
              ...
              <table class="table table-bordered">
                ...
                <tbody id="table_body">
                  ...
                  @else
                    ...
                    @foreach($variety->varietyData as $key => $value)

                      <tr>

                        <td>
                          <div class="form-group">
                            <input type="text" name="row[{{ $key }}][seq_no]" class="form-control" placeholder="Seq No." value="{{ $value->seq_no }}" >
                            <small class="text-danger">{{ $errors->first('row.'. $key .'.seq_no') }}</small>
                          </div>
                        </td>
...
@section('scripts')
    ...
    $(document).ready(function() {
      $("#add_row").on("click", function() {
        ...
        var content ='<tr>' +
                        ...
                        '<td>' +
                          '<div class="form-group">' +
                            '<textarea  type="text" name="row[' + i + '][value]" class="form-control" rows="4"></textarea>' +
                          '</div>' +
                        '</td>' +
  ...
  {!! __js::img_upload('doc_file', 'fa', route('dashboard.variety.view_img', $variety->slug)) !!}
