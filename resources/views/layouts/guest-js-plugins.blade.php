...
<script type="text/javascript" src="{{ asset('template_guest/js/owl-carousel-thumb.min.js') }}"></script>

<script type="text/javascript" src="{{ asset('template_guest/js/jquery.ajaxchimp.min.js') }}"></script>

<script type="text/javascript" src="{{ asset('template_guest/js/mail-script.js') }}"></script>
