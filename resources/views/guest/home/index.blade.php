                    ...
                    @foreach ($news_list as $data)
                        <div class="single_course">
                          <div class="course_head">
                            @if (isset($data->img_location) && Storage::disk('local')->exists($data->img_location))
                              <img class="img-fluid" src="{{ route('guest.news.view_img', $data->slug) }}" alt="" />
                            @else
                              <img class="img-fluid" src="{{ asset('images/no-image.jpg') }}" alt="" />
                            @endif
                          </div>
