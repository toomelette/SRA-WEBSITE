    ...
    <div class="container-fluid">
        <div class="row">
          <div class="col-lg-9 posts-list">
            {{ Breadcrumbs::render('industryUpdate_eic') }}
            <div class="single-post row">

              <div class="col-lg-12 col-md-12 blog_details">
                <h3 class="text-heading title_color">Expired Import Clearance</h3>
              </div>
              
              <div class="container">

                <form data-pjax class="form" id="filter_form" method="GET" autocomplete="off" action="{{ route('guest.industry_update.eic') }}">
                ...
                <div id="pjax-container">
                  <table class="table table-striped table-bordered" style="width:100%">
                    <thead>
                      <td style="color:red;">@sortablelink('year', 'Year')</td>
                      <td style="color:red;">@sortablelink('expiredImportClearanceCategory.name', 'Category')</td>
                      <td style="color:red;">@sortablelink('title', 'Title')</td>
                      <td style="width:150px;"></td>
                    </thead>
                    <tbody>
                      @foreach ($eic_list as $data)
                        <tr>
                          ...
                          <td id="mid-vert">
                            <a href="{{ route('guest.industry_update.view_eic_doc', $data->slug) }}" class="genric-btn btn-info small" target="_blank">
                              Download
                            </a>
                          </td>
                        </tr>
                  ...
                  {!! __html::table_counter($eic_list) !!}
                  {!! $eic_list->appends([])->render('vendor.pagination.bootstrap-4')!!}
