    ...
    <div class="container-fluid">
        <div class="row">
          <div class="col-lg-9 posts-list">
            {{ Breadcrumbs::render('industryUpdate_ssads') }}
            <div class="single-post row">

              <div class="col-lg-12 col-md-12 blog_details">
                <h3 class="text-heading title_color">Sugar Supply and Demand Situation</h3>
              </div>
              
              <div class="container">

                <form data-pjax class="form" id="filter_form" method="GET" autocomplete="off" action="{{ route('guest.industry_update.ssads') }}">
                ...
                <div id="pjax-container">
                  <table class="table table-striped table-bordered" style="width:100%">
                    ...
                    <tbody>
                      @foreach ($ssads as $data)
                        <tr>
                          <td id="mid-vert">{{ $data->title }}</td>
                          <td id="mid-vert">
                            <a href="{{ route('guest.industry_update.view_ssads_doc', $data->slug) }}" class="genric-btn btn-info small" target="_blank">
                              Download
                            </a>
                          </td>
                        </tr>
                  ...
                  {!! __html::table_counter($ssads) !!}
                  {!! $ssads->appends([])->render('vendor.pagination.bootstrap-4')!!}
