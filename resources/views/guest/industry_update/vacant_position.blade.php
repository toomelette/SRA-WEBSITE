    ...
    <div class="container-fluid">
        <div class="row">
          <div class="col-lg-9 posts-list">
            {{ Breadcrumbs::render('industryUpdate_vacantPosition') }}
            <div class="single-post row">

              <div class="col-lg-12 col-md-12 blog_details">
                <h3 class="text-heading title_color">Vacant Positions</h3>
              </div>
              
              <div class="container">

                <form data-pjax class="form" id="filter_form" method="GET" autocomplete="off" action="{{ route('guest.industry_update.vacant_position') }}">
                ...
                <div id="pjax-container">
                    ...
                    <tbody>
                      @foreach ($vacant_positions as $data)
                        <tr>
                          ...
                          <td id="mid-vert">
                            <a href="{{ route('guest.industry_update.view_vacant_position_doc', $data->slug) }}" class="genric-btn btn-info small" target="_blank">
                              Download
                            </a>
                          </td>
                        </tr>
                  ...
                  {!! $vacant_positions->appends([])->render('vendor.pagination.bootstrap-4')!!}
