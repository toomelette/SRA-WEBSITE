    ...
    <div class="container-fluid">
        <div class="row">
          <div class="col-lg-9 posts-list">
            {{ Breadcrumbs::render('industryUpdate_blockFarm') }}
            <div class="single-post row">

              <div class="col-lg-12 col-md-12 blog_details">
                <h3 class="text-heading title_color">Block Farm</h3>
              </div>
              
              <div class="container">

                <form data-pjax class="form" id="filter_form" method="GET" autocomplete="off" action="{{ route('guest.industry_update.block_farm') }}">
                ...
                <div id="pjax-container">
                    ...
                    <tbody>
                      @foreach ($block_farms as $data)
                        <tr>
                          ...
                          <td id="mid-vert">
                            <a href="{{ route('guest.industry_update.view_block_farm_doc', $data->slug) }}" class="genric-btn btn-info small" target="_blank">
                              Download
                            </a>
                          </td>
                        </tr>
                  ...
                  {!! $block_farms->appends([])->render('vendor.pagination.bootstrap-4')!!}
