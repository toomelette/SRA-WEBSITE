    ...
    <div class="container-fluid">
        <div class="row">
          <div class="col-lg-9 posts-list">
            {{ Breadcrumbs::render('policies_memoOrder') }}
            <div class="single-post row">

              <div class="col-lg-12 col-md-12 blog_details">
                <h3 class="text-heading title_color">Memorandum Orders</h3>
              </div>
              
              <div class="container">

                <form data-pjax class="form" id="filter_form" method="GET" autocomplete="off" action="{{ route('guest.policies.memo_order') }}">
                ...
                <div id="pjax-container">
                  <table class="table table-striped table-bordered" style="width:100%">
                    ...
                    <tbody>
                      @foreach ($memo_orders as $data)
                        <tr>
                          <td id="mid-vert">{{ $data->title }}</td>
                          <td id="mid-vert">{{ optional($data->cropYear)->name }}</td>
                          <td id="mid-vert">
                            <a href="{{ route('guest.policies.view_memo_order_doc', $data->slug) }}" class="genric-btn btn-info small" target="_blank">
                              Download
                            </a>
                          </td>
                        </tr>
                  ...
                  @if($memo_orders->isEmpty())
                    <div style="padding :5px;">
                      <center><h4>No Records found!</h4></center>
                    </div>
                  @endif

                  {!! __html::table_counter($memo_orders) !!}
                  {!! $memo_orders->appends([])->render('vendor.pagination.bootstrap-4')!!}
