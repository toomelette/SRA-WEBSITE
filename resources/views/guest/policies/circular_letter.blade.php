    ...
    <div class="container-fluid">
        <div class="row">
          <div class="col-lg-9 posts-list">
            {{ Breadcrumbs::render('policies_circularLetter') }}
            <div class="single-post row">
              ...
              <div class="container">
                ...
                <form data-pjax class="form" id="filter_form" method="GET" autocomplete="off" action="{{ route('guest.policies.circular_letter') }}">
                ...
                <div id="pjax-container">
                  <table class="table table-striped table-bordered" style="width:100%">
                    ...
                    <tbody>
                      @foreach ($circular_letters as $data)
                        <tr>
                          <td id="mid-vert">{{ $data->title }}</td>
                          <td id="mid-vert">{{ optional($data->cropYear)->name }}</td>
                          <td id="mid-vert">
                            <a href="{{ route('guest.policies.view_circular_letter_doc', $data->slug) }}" class="genric-btn btn-info small" target="_blank">
                              Download
                            </a>
                          </td>
                        </tr>
                  ...
                  @if($circular_letters->isEmpty())
                    <div style="padding :5px;">
                      <center><h4>No Records found!</h4></center>
                    </div>
                  @endif

                  {!! __html::table_counter($circular_letters) !!}
                  {!! $circular_letters->appends([])->render('vendor.pagination.bootstrap-4')!!}
