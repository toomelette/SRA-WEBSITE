    ...
    <div class="container-fluid">
        <div class="row">
          <div class="col-lg-9 posts-list">
            {{ Breadcrumbs::render('sida_sidaLaws') }}
            <div class="single-post row">

              <div class="col-lg-12 col-md-12 blog_details">
                <h3 class="text-heading title_color">SIDA Laws</h3>
              </div>
              
              <div class="container">

                <form data-pjax class="form" id="filter_form" method="GET" autocomplete="off" action="{{ route('guest.sida.sida_law') }}">
                ...
                <div id="pjax-container">
                    ...
                    <tbody>
                      @foreach ($sida_laws as $data)
                        <tr>
                          ...
                          <td id="mid-vert">
                            <a href="{{ route('guest.sida.view_sida_law_doc', $data->slug) }}" class="genric-btn btn-info small" target="_blank">
                              Download
                            </a>
                          </td>
                        </tr>
                  ...
                  {!! $sida_laws->appends([])->render('vendor.pagination.bootstrap-4')!!}
