    ...
    <div class="container-fluid">
        <div class="row">
          <div class="col-lg-9 posts-list">
            {{ Breadcrumbs::render('sida_sidaFU') }}
            <div class="single-post row">

              <div class="col-lg-12 col-md-12 blog_details">
                <h3 class="text-heading title_color">SIDA Fund Utilization</h3>
              </div>
              
              <div class="container">

                <form data-pjax class="form" id="filter_form" method="GET" autocomplete="off" action="{{ route('guest.sida.sida_fu') }}">
                ...
                <div id="pjax-container">
                  ...
                  @if($sida_fu_list->isEmpty())
                    <div style="padding :5px;">
                      <center><h4>No Records found!</h4></center>
                    </div>
                  @endif

                  {!! __html::table_counter($sida_fu_list) !!}
                  {!! $sida_fu_list->appends([])->render('vendor.pagination.bootstrap-4')!!}
